...
public enum ExceptionResponse {
    ...
    MULTIPLE_ACTIVE_ACADEMIC_PERIODS("ERR_ACADEMIC_PERIOD_006",
    ...
    INVESTIGATION_GROUP_ALREADY_EXISTS("ERR_INVESTIGATION_GROUP_003",
            "Ya existe un grupo de investigación con ese nombre."),
    ...
    RESEARCH_SEEDBED_ALREADY_EXISTS("ERR_RESEARCH_SEEDBED_003",
            "Ya existe un semillero de investigación con ese nombre."),
